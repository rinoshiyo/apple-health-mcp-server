...
DESCRIPTION = (
    ...
    "For the user-visible total time spanning queue → done -- including "
    "ZIP extraction -- use get_import_status.duration_secs on the matching "
    "job. The two values can differ by several seconds on large ZIPs.), "
