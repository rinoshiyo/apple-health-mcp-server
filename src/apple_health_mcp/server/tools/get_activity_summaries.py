...
DESCRIPTION = (
    ...
    "rings come back correctly), apple_exercise_time, apple_exercise_time_goal, "
    "apple_stand_hours, apple_stand_hours_goal. Values are in <unit>, "
...
def register(mcp: FastMCP, conn: duckdb.DuckDBPyConnection, lock: Lock) -> None:
    ...
    async def get_activity_summaries(
        ...
        sql_parts = ["SELECT * FROM activity_summaries WHERE 1=1"]
        params: list[Any] = []
